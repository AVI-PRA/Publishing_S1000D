...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
            ...
            <div class="col-12">
                <div class="levelOneBar  mb-3 rounded">
                    ...
                    <div class="d-flex">
                        ...
                        <xsl:if test="count(ancestor::*[local-name()='levelledPara']) = 0 and (ancestor::*[local-name()='procedure']/*[local-name()='levelledPara'] or ancestor::*[local-name()='description']/*[local-name()='levelledPara'])">
                            <div class="roundedBullet">
                                <xsl:number level="single" count="*[local-name()='levelledPara']"/>
                            </div>
                        </xsl:if>
                        <!-- Title -->
    ...
    <xsl:template match="*[local-name()='para']">
        <xsl:choose>
            <xsl:when test="parent::*[local-name()='levelledPara'] | parent::*[local-name()='note'] | parent::*[local-name()='listItem']">
                <div class="d-flex">
                    <xsl:call-template name="add-applic-attribute"/>
    ...
    <xsl:template match="*[local-name()='note']">
        <div class="d-flex">
            ...
            <div class="para0TextDescription flex-grow-1 pb-3">
                <b>Note
                    <xsl:number level="any" count="*[local-name()='note']" from="*[local-name()='content']"/>
                </b>
                <br/>
