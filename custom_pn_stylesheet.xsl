...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="para">
        ...
        <xsl:choose>
            <xsl:when test="parent::levelledPara | parent::note | parent::listItem">
                <!-- If para is direct child of these -->
                <div class="d-flex">
                    <div class="para0Indent"/>
                    <!-- Always indent paragraphs within these structures? -->
            ...
            <xsl:otherwise>
                ...
                <div class="row">
                    <div class="col-12">
                        <!-- Simple row/col wrapper -->
                        <p>
                            <xsl:apply-templates/>
                        </p>
                        <!-- Default to simple paragraph if context unclear -->
                    </div>
                </div>
            </xsl:otherwise>
        </xsl:choose>
